...
FunctionPass *createAArch64NaClMFPass(); //arm nacl
FunctionPass *createAArch64NaClMFPassDebugPre(); //arm nacl
FunctionPass *createAArch64NaClMFPassDebugPost(); //arm nacl
